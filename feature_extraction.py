...
# Calculez FGrating mediu pentru fiecare dintre cele trei piste:Sha Tin Grass, Sha Tin Dirt si Happy Valley Grass pentru fiecare cal
c.compute_average_fgratings_for_every_track(featured_data)

# Calculez pozitia medie pentru fiecare dintre cele trei piste:Sha Tin Grass, Sha Tin Dirt si Happy Valley Grass pentru fiecare cal
...
# Calculez procentajul de victorii al unui jocheu in ultimele 1000 de zile, pe cele trei tipuri de distante si pe cele
...
# Calculez pozitia finala medie a unui jocheu in ultimele 1000 de zile pe cele trei tipuri de distante si pe cele
# doua tipuri de suprafata.
c.compute_jockey_average_final_position_on_tracks_and_surfaces(featured_data)

# Calculez pozitia medie de plecare ('"Path"') a unui jocheu in ultimele 1000 de zile
c.compute_jockey_mean_path(featured_data)

# Calculez pozitia medie de plecare ('"Path"') a unui jocheu in ultimele 1000 de zile, in functie de suprafata
c.compute_jockey_mean_path_on_surface(featured_data)

# Calculez pozitia medie de plecare ('"Path"') a unui jocheu in ultimele 1000 de zile, in functie de pista si suprafata
...
featured_data = featured_data.drop(
    columns=['cumsum', 'Index', 'Løpsnr', 'Jockey', 'Dato', 'RaceType', 'TrainerName', 'Country', 'Path', 'Tid',
             'Ridevekt'])
